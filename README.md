...
Aplicación web moderna desarrollada con **Next.js**, **TypeScript** y **Tailwind CSS** que nos permite generar contraseñas seguras y personalizadas. La interfaz está diseñada para ser simple, intuitiva y educativa, incorporando *tooltips* informativos para conceptos técnicos.
